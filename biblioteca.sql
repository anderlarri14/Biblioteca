...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-12-2021 a las 23:36:24
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getBookInfo` (IN `iId` INT(15) UNSIGNED)  SELECT * FROM catalogo WHERE id=iId$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `insertCompra` (IN `iUsuario` INT(10), IN `iLibro` INT(10))  INSERT INTO compras (id_usuario,id_libro) 
...
INSERT INTO `catalogo` (`id`, `titulo`, `autor`, `precio`, `genero`, `descripcion`) VALUES
